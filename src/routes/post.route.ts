...
import { get_all_posts_with_search, get_all_posts, get_single_post } from '../controllers/getPosts'
...
router.get('/all_posts/search', get_all_posts_with_search)
router.get('/all_posts', get_all_posts)
router.get('/posts', get_single_post)
